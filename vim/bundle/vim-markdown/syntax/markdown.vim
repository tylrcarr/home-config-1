...
syn region markdownLinkText matchgroup=markdownLinkTextDelimiter start="!\=\[\%(\_[^]]*]\)\@=" end="\]" nextgroup=markdownId skipwhite contains=@markdownInline,markdownLineStart
...
hi def link markdownLinkText              Typedef
